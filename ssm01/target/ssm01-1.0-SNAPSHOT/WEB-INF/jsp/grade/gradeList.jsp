	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果年级下存在班级信息则无法删除", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div><a id="delete" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-some-delete',plain:true">删除</a>
			 年级名：<input class="easyui-textbox" id="serarch-name">
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, validType:'repeat', missingMessage:'请输入姓名'" />
	    			</td>
